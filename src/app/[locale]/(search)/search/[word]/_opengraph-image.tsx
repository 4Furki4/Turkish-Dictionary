...
// Image generation
export default async function Image({ params }: { params: { locale: string, word: string } }) {
    ...
    const wordMessage = isEnglish ? `The definition of "${params.word}"` : `"${params.word}" kelimesinin tanımları`;
